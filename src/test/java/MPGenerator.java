...
public class MPGenerator {
    public static void main(String[] args) {
        ...
        packageConfig.setParent("com.lvch.scaffold.common");//自定义包的路径
...
//        strategyConfig.setTablePrefix("t_");
        ...
        strategyConfig.setInclude(
                "base_login_account_auth", "base_user_account", "base_user_profile", "base_user_atributes"
        );
...
//        strategyConfig.setTableFillList(list);
    ...
    public static void assembleDev(DataSourceConfig dataSourceConfig) {
        ...
        dataSourceConfig.setUrl("jdbc:mysql://xxxx:3306/base_scaffold?useUnicode=true&characterEncoding=utf-8&useSSL=true&serverTimezone=UTC");
    }
}
